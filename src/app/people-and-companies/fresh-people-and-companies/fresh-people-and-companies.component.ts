...
@Component({
  selector: 'app-fresh-people-and-companies',
  templateUrl: './fresh-people-and-companies.component.html',
  styleUrls: ['./fresh-people-and-companies.component.css'],
  providers: [ConfirmationService,MessageService]
})
export class FreshPeopleAndCompaniesComponent implements OnInit {
