...
@Component({
  selector: 'app-personal-name',
  templateUrl: './personal-name.component.html',
  styleUrls: ['./personal-name.component.css']
})
export class PersonalNameComponent implements OnInit {
